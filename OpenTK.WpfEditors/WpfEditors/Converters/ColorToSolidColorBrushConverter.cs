...
public class Color4ToSolidColorBrushConverter : IValueConverter
{
                           ...
                           System.Globalization.CultureInfo culture)
    {
        if(value != null)
        {
            return new SolidColorBrush(((Color4)value).ToSystemWindowsMedia());
        }
                               ...
                               System.Globalization.CultureInfo culture)
    {
        if(value != null)
        {
            return ((SolidColorBrush)value).Color.ToOpenTK();
        }
