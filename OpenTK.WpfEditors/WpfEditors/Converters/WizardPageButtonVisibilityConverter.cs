...
//        Visibility wizardVisibility = values[0] == null || values[0] == DependencyProperty.UnsetValue ? Visibility.Hidden : (Visibility)values[0];

//        WizardPageButtonVisibility wizardPageVisibility = values[1] == null || values[1] == DependencyProperty.UnsetValue ? WizardPageButtonVisibility.Hidden : (WizardPageButtonVisibility)values[1];
