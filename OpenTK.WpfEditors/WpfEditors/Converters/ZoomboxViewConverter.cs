...
//                        foreach(string token in (value as string).Split(new char[]
//                                                                        {
//                                                                            ' ', ';', ','
//                                                                        },
...
//                        else
//                        {
//                            result = view.Scale.ToString() + "," + view.Position.X.ToString() + "," + view.Position.Y.ToString();
//                        }
...
//                        result = view.Region.X.ToString() + "," + view.Region.Y.ToString() + "," + view.Region.Width.ToString() + "," + view.Region.Height.ToString();
//                        break;
//                }
//            }
//        }
