...
//        if(value == null || (stringValue != null && stringValue.Trim() == string.Empty))
//        {
...
//                result = result + _keyModifierConverter.ConvertTo(typeDescriptorContext, cultureInfo, modifier, destinationType);
//            }
